...
the false discovery proportion (FDP) which the Benjamini-Hochberg method
controls at a pre-specified level. Indeed, this is controlled for our
t-test:
...
The actual level is `r round(FDP, 3)` less than the 10% we set. If we now 
...
[Testing significance relative to a fold-change threshold is a TREAT](dx.doi.org/10.1093/bioinformatics/btp053)
